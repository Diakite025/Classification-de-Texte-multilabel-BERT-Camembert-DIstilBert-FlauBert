...
import entrainementDuModelFlauBert ,utility,importEtInsert_data
import pandas as pd
...
class EvaluationModel():
    ...
    def __init__(self,df_test,target_list,path='BestModel/modelFlauBert.pth'):
        ...
        model=entrainementDuModelFlauBert.FlauBertClass()
        model.eval()
...
def main(df: pd.DataFrame = None, target_list:list = utility.Liste_categories(),lien_collection_test="test_fr",path="BestModel/modelFlauBert.pth"):
    """
