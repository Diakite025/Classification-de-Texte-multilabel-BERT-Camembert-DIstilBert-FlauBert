...
class ModelFlauBert:
    ...
    def Création_model(self):
        ...
        self.model=FlauBertClass(self.nb_classes)
...
def main(lien_collection_train="train_fr",lien_collection_valid="valid_fr",target_list= utility.Liste_categories(),path="BestModel/modelFlauBert.pth"):
    ...
    modelFlauBert=ModelFlauBert(df_train,df_valid,target_list,path)
    
    modelFlauBert.preparation_des_données()
    modelFlauBert.Création_model()
    modelFlauBert.EntrainementModele()
