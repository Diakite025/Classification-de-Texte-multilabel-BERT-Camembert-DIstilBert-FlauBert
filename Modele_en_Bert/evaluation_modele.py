...
import entrainementDuModeleBert ,importEtInsert_data,utility
import pandas as pd
...
class EvaluationModel():
    ...
    def __init__(self,df_test,target_list,path="BestModel/model_en_V2.pth"):
        ...
        model=entrainementDuModeleBert.BertClass()
...
def main(df: pd.DataFrame = None,target_list:list = utility.Liste_categories(),lien_collection_test="df_test_en",path="BestModel/model_en_V2.pth"):
