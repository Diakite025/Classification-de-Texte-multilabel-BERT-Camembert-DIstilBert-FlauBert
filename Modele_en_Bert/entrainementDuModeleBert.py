...
class ModelBert:
    ...
    def Création_model(self):
        ...
        self.model=BertClass(self.nb_classes)
...
def main(lien_collection_train="Train_Oversampling_en",lien_collection_valid="df_valid_en",target_list= utility.Liste_categories(),path="BestModel/model_en_V2.pth"):
    ...
    modelBert=ModelBert(df_train,df_valid,target_list,path)
    
    modelBert.preparation_des_données()
    modelBert.Création_model()
    modelBert.EntrainementModele()
